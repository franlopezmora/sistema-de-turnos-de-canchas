...
-- CreateIndex
CREATE INDEX "CashShift_cashRegisterId_status_idx" ON "CashShift"("cashRegisterId", "status");
...
-- AddForeignKey
ALTER TABLE "CashShift" ADD CONSTRAINT "CashShift_cashRegisterId_fkey" FOREIGN KEY ("cashRegisterId") REFERENCES "CashRegister"("id") ON DELETE CASCADE ON UPDATE CASCADE;
