...
describe('ErrorCodes — catálogo', () => {
  ...
  test('codes críticos existen', () => {
    const required = [
      ...
      'BOOKING_FORBIDDEN', 'BOOKING_CANCELLATION_NOT_ALLOWED', 'BOOKING_HAS_PAYMENTS',
      'BOOKING_PARTICIPANT_NOT_FOUND', 'BOOKING_PARTICIPANT_ALREADY_EXISTS',
      'BOOKING_PARTICIPANT_FORBIDDEN', 'BOOKING_INVITATION_NOT_FOUND',
      'BOOKING_INVITATION_EXPIRED', 'BOOKING_INVITATION_INVALID',
      'BOOKING_INVITATION_ALREADY_ACCEPTED', 'BOOKING_INVITATION_ALREADY_DECLINED',
      'BOOKING_INVITATION_EMAIL_MISMATCH', 'BOOKING_CANNOT_INVITE_PARTICIPANTS',
      'BOOKING_CANNOT_LEAVE',
      ...
      'MEMBERSHIP_NOT_FOUND', 'MEMBERSHIP_ROLE_INVALID', 'MEMBERSHIP_ALREADY_EXISTS',
      'MEMBERSHIP_LAST_OWNER', 'MEMBERSHIP_FORBIDDEN',
      // Cuentas / pagos / caja
