        ...
        <div className="absolute z-[110] w-full mt-2 bg-p-surface border-2 border-lima-900/10 rounded-2xl shadow-2xl max-h-64 overflow-y-auto overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
          {results.length > 0 ? (
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 shrink-0">
                      <span className="font-black text-ink-900">${Number(product.price || 0).toLocaleString()}</span>
            ...
            <div className="p-8 text-center">
              ...
              <p className="text-xs font-bold text-ink-900/40 uppercase tracking-widest">No se encontraron productos</p>
            </div>
          )}
        </div>
      )}
